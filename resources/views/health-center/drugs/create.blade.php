                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="insurance_covered" id="insuranceCovered">
        ...
        <div class="col-lg-4">
            <div class="card mb-4">
                <div class="card-header bg-info text-white">
                    <h6 class="mb-0"><i class="fas fa-lightbulb me-2"></i>إرشادات</h6>
                </div>
                <div class="card-body">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <ul class="list-unstyled mb-0">
                        <li class="mb-1"><i class="fas fa-clock text-warning me-2"></i>ستظهر في قائمة "الأدوية المعلقة"</li>
...
function submitNewDrug() {
    ...
    $.ajax({
        ...
        data: {
            ...
            insurance_covered: formData.has('insurance_covered'),
